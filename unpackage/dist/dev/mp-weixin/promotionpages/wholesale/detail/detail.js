...
var _detail = _interopRequireDefault(__webpack_require__(/*! ./promotionpages/wholesale/detail/detail.vue */ 623));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;
...
/* harmony import */ var _detail_vue_vue_type_template_id_02f2adfe_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./detail.vue?vue&type=template&id=02f2adfe&scoped=true& */ 624);
/* harmony import */ var _detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./detail.vue?vue&type=script&lang=js& */ 626);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _detail_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var _detail_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./detail.vue?vue&type=style&index=0&lang=scss& */ 638);
/* harmony import */ var _detail_vue_vue_type_style_index_1_id_02f2adfe_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./detail.vue?vue&type=style&index=1&id=02f2adfe&scoped=true&lang=css& */ 640);
...
try {
  components = {
    ...
    nsGoodsSku: function() {
      return Promise.resolve(/*! import() */).then(__webpack_require__.bind(null, /*! @/components/ns-goods-sku/ns-goods-sku.vue */ 628))
    },
...
var _nsGoodsSku = _interopRequireDefault(__webpack_require__(/*! @/components/ns-goods-sku/ns-goods-sku.vue */ 628));


var _detail = _interopRequireDefault(__webpack_require__(/*! ../public/js/detail.js */ 637));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ns_goods_sku_vue_vue_type_template_id_407fe378_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ns-goods-sku.vue?vue&type=template&id=407fe378&scoped=true& */ 629);
/* harmony import */ var _ns_goods_sku_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ns-goods-sku.vue?vue&type=script&lang=js& */ 631);
...
/* harmony import */ var _ns_goods_sku_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ns-goods-sku.vue?vue&type=style&index=0&lang=scss& */ 633);
/* harmony import */ var _ns_goods_sku_vue_vue_type_style_index_1_id_407fe378_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ns-goods-sku.vue?vue&type=style&index=1&id=407fe378&scoped=true&lang=css& */ 635);
/* harmony import */ var _Applications_HBuilderX_app_Contents_HBuilderX_plugins_uniapp_cli_node_modules_dcloudio_vue_cli_plugin_uni_packages_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../../../../Applications/HBuilderX.app/Contents/HBuilderX/plugins/uniapp-cli/node_modules/@dcloudio/vue-cli-plugin-uni/packages/vue-loader/lib/runtime/componentNormalizer.js */ 13);
...
try {
  components = {
    ...
    myPopupSelect: function() {
      return __webpack_require__.e(/*! import() | components/my-popup-select/my-popup-select */ "components/my-popup-select/my-popup-select").then(__webpack_require__.bind(null, /*! @/components/my-popup-select/my-popup-select.vue */ 1530))
    }
  }
} catch (e) {
  if (
...
var _htmlParser = _interopRequireDefault(__webpack_require__(/*! @/common/js/html-parser */ 208));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var uniPopup = function uniPopup() {__webpack_require__.e(/*! require.ensure | components/uni-popup/uni-popup-sku */ "components/uni-popup/uni-popup-sku").then((function () {return resolve(__webpack_require__(/*! @/components/uni-popup/uni-popup-sku.vue */ 1537));}).bind(null, __webpack_require__)).catch(__webpack_require__.oe);};
// 商品SKU
var _default = {
  name: 'ns-goods-sku',
  components: {
  ...
  watch: {
    rimless: function rimless(nval, oval) {
  ...
  methods: {
    ...
    getList: function getList() {var min = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;var max = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
      ...
      for (var i = min; i <= max; i += s) {
        ...
        console.log("min=".concat(min, ",max=").concat(max, ",s=").concat(s, ",step=").concat(this.goodsDetail.step, ",i=").concat(i));
      ...
      if (this.goodsDetail.luminosity_status == 1) {
        ...
        if (name == 'cylinder' && dataitem != null) {
          ...
          this.mirrolist.forEach(function (v) {
            ...
            val, ",ball_min = ").concat(v.ball_min, ",ball_max=").concat(v.ball_max, ",Number(val) > v.ball_min =").concat(Number(val) > v.ball_min, " Number(val) <= v.ball_max=").concat(Number(val) <= v.ball_max));
    ...
    getWholesale: function getWholesale() {var _this4 = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var res, mirro;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:_context.next = 2;return (
                ...
                console.log(_this4.goodsDetail.luminosity_status, "状态码新产品", _this4.goodsDetail);if (!(
                _this4.goodsDetail.luminosity_status != 1)) {_context.next = 7;break;}return _context.abrupt("return");case 7:
                console.log("开始插球镜柱镜");_context.next = 10;return (
                  _this4.$api.sendRequest({
                    url: '/api/goodssku/luminosity_sku',
                    data: {
                      goods_id: _this4.goodsDetail.goods_id },

                    async: false }));case 10:mirro = _context.sent;

                delete mirro.timestamp;
                _this4.mirrolist = Object.values(mirro);
                if (_this4.mirrolist.length == 0) uni.showToast({
                  title: "没有拉取到柱镜信息,请刷新重试",
                  icon: "none" });

                _this4.setBalllist();case 15:case "end":return _context.stop();}}}, _callee);}))();
    },
    ...
    //点击增加单笔数量
    getClickGoodsAdd: function getClickGoodsAdd(obj) {var eyeIndex = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
